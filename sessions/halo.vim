...
set shortmess=aoO
badd +13 setup/sql/update.sql
badd +380 lib/R/model/stack.R
argglobal
silent! argdel *
argadd setup/sql/update.sql
edit lib/R/model/stack.R
...
setlocal tabstop=4
setlocal tags=~/engg/.git/r.tags,~/engg/.git/tags,~/.mytags
...
silent! normal! zE
let s:l = 381 - ((26 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
381
normal! 030|
lcd ~/engg/lib/R/model
tabedit ~/engg/setup/sql/update.sql
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal tabstop=4
setlocal tags=~/engg/.git/sql.tags,~/engg/.git/tags,~/.mytags
setlocal textwidth=79
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
